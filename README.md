...
The interface starts in Portuguese for existing installs. Open **Preferências / Preferences** and choose **English** under **Idioma / Language**; the choice is saved in the RamDog config and applies to navigation, metrics, startup, screens, and addon entry points without changing existing settings.
